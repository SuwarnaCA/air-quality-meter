...
void setup()
{
  ...
  Serial.print("Calibration mq2 is done...\n"); 
   Serial.print("Calibrating mq6...\n");                
  Ro = MQCalibration1(MQ_PIN_6);                       //Calibrating the sensor. Please make sure the sensor is in clean air 
                                                    //when you perform the calibration                    
  Serial.print("Calibration mq6 is done...\n");
  Serial.print("Ro=");
  Serial.print(Ro);
  Serial.print("kohm");
  Serial.print("\n");
...
void loop()
{
   ...
   Serial.print("    "); 
   Serial.print("CH4::"); 
   Serial.print(MQGetGasPercentage1(MQRead(MQ_PIN_6)/Ro,GAS_CH4) );
   Serial.print( "ppm" );
   Serial.print("\n");
   delay(100);
}
...
float MQCalibration1(int mq_pin_6)
{
  int i;
  float val1=0;
...
int MQGetGasPercentage1(float rs_ro_ratio1, int gas_id1)
{
   if ( gas_id1 == GAS_CH4 ) {
...
int  MQGetPercentage1(float rs_ro_ratio1, float *pcurve1)
{
